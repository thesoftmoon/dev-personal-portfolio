...
import projectsDataEs from '../locales/es/global.json'
import projectsDataEn from '../locales/en/global.json'
...
function Portfolio() {
  ...
  if(i18n.language === "es"){
    console.log('Spanish')
    projectsData = projectsDataEs.projects.projectsInfo;


  }  else if (i18n.language === "en"){
    console.log('English')
    projectsData = projectsDataEn.projects.projectsInfo;
    ...
    <div id="projects" className="projects" data-aos='fade-left'>
      ...
      <div className="row d-flex justify-content-between">
        {projectsData.map((card, index) => (
          ...
          >
            <Modal imageRoute={require(`../${card.image}`)} modalImg={require(`../${card.image}`)} mainTxt={card.title} sideTxt={card.longInfo} />
